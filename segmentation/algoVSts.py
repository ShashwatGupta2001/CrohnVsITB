...
def func(slice_img):
    ...
    thresh = cv2.dilate(cv2.erode(slice_img, kernel, iterations=1), kernel, iterations=1)
...
def main():
    ...
    print("Initial Data2 shape:", data2.shape)
    if data2.sum() == 0:
        print("Data2 is empty after combining subcutaneous and torso fat segmentations.")
    ...
    # print("Data1 shape after slicing:", data1.shape)
    # print("Data2 shape after slicing:", data2.shape)
    # print("Data1 sum after slicing:", data1.sum())
    # print("Data2 sum after slicing:", data2.sum())
    ...
    result = {
        "algVts_" + option + "_dice": str(dice_score),
        "algVts_" + option + "_jaccard": str(jaccard_score),
    }
